...
INSERT INTO cart_items (id, cart_id, menu_item_id, quantity, created_at, updated_at) VALUES (1, 1, 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO notifications (id, user_id, message, is_read, type, created_at, updated_at) VALUES (1, 1, 'Hệ thống đã sẵn sàng vận hành.', false, 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO orders (id, customer_id, restaurant_id, status, total_amount, delivery_fee, delivery_address, created_at) VALUES
                                                                                                                          (10, 2, 1, 'DELIVERED', 450000, 15000, '123 Quận 1', CURRENT_TIMESTAMP - INTERVAL '7' DAY),
                                                                                                                          (11, 5, 1, 'DELIVERED', 120000, 15000, '456 Quận 3', CURRENT_TIMESTAMP - INTERVAL '6' DAY),
                                                                                                                          (12, 6, 1, 'DELIVERED', 890000, 15000, '789 Bình Thạnh', CURRENT_TIMESTAMP - INTERVAL '5' DAY);


INSERT INTO orders (id, customer_id, restaurant_id, status, total_amount, delivery_fee, delivery_address, created_at) VALUES
                                                                                                                          (14, 2, 1, 'DELIVERED', 1250000, 15000, '123 Quận 1', CURRENT_TIMESTAMP - INTERVAL '3' DAY),
                                                                                                                          (15, 5, 1, 'DELIVERED', 980000, 15000, '456 Quận 3', CURRENT_TIMESTAMP - INTERVAL '2' DAY),
                                                                                                                          (16, 6, 1, 'DELIVERED', 2100000, 15000, '789 Bình Thạnh', CURRENT_TIMESTAMP - INTERVAL '1' DAY);


INSERT INTO orders (id, customer_id, restaurant_id, status, total_amount, delivery_fee, delivery_address, created_at) VALUES
                                                                                                                          (24, 5, 1, 'PREPARING', 240000, 15000, '789 Cách Mạng Tháng 8', CURRENT_TIMESTAMP - INTERVAL '8' MINUTE),
                                                                                                                          (25, 6, 1, 'PENDING', 360000, 15000, '321 Nam Kỳ Khởi Nghĩa', CURRENT_TIMESTAMP - INTERVAL '1' MINUTE),
                                                                                                                          (32, 5, 1, 'CANCELLED', 45000, 15000, 'Hẻm 123 Võ Văn Tần, Quận 3', CURRENT_TIMESTAMP - INTERVAL '30' MINUTE);
...
ALTER TABLE restaurants ALTER COLUMN id RESTART WITH 20;
ALTER TABLE categories ALTER COLUMN id RESTART WITH 20;
ALTER TABLE menu_items ALTER COLUMN id RESTART WITH 50;
ALTER TABLE carts ALTER COLUMN id RESTART WITH 20;
ALTER TABLE orders ALTER COLUMN id RESTART WITH 100;
ALTER TABLE order_items ALTER COLUMN id RESTART WITH 200;